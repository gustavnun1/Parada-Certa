 -- =============================================
  ...
  ([clienteId], [estacionamentoId], [horaEntrada], [horaSaida], [horaPagamento], [valorPago], [status], [qrCode], [reservado], [placa])
  VALUES
  (1, 1, DATEADD(HOUR, -5, SYSDATETIME()), DATEADD(HOUR, -3, SYSDATETIME()), DATEADD(HOUR, -3, SYSDATETIME()), 30.00, 'ENCERRADA', 'DEMO-SESSAO-APP-0001', 0, 'ABC1D23'),
  (2, 2, DATEADD(HOUR, -4, SYSDATETIME()), DATEADD(HOUR, -2, SYSDATETIME()), DATEADD(HOUR, -2, SYSDATETIME()), 18.00, 'ENCERRADA', 'DEMO-SESSAO-APP-0002', 0, 'DEF4G56'),
  (3, 5, DATEADD(HOUR, -6, SYSDATETIME()), DATEADD(HOUR, -2, SYSDATETIME()), DATEADD(HOUR, -2, SYSDATETIME()), 100.00, 'ENCERRADA', 'DEMO-SESSAO-APP-0003', 0, 'GHI7J89'),
  (4, 3, DATEADD(MINUTE, -45, SYSDATETIME()), NULL, NULL, NULL, 'ATIVA', 'DEMO-SESSAO-ATIVA-0001', 0, 'JKL2M34'),
  (5, 6, DATEADD(MINUTE, -20, SYSDATETIME()), NULL, DATEADD(MINUTE, -20, SYSDATETIME()), 20.00, 'ATIVA', 'DEMO-RESERVA-ATIVA-0001', 1, 'MNO5P67'),
  (6, 1, DATEADD(DAY, -1, SYSDATETIME()), DATEADD(HOUR, 1, DATEADD(DAY, -1, SYSDATETIME())), DATEADD(DAY, -1, SYSDATETIME()), 0.00, 'CANCELADA', 'DEMO-RESERVA-CANCELADA-0001', 1, 'QRS8T90'),
  (NULL, 1, DATEADD(HOUR, -3, SYSDATETIME()), DATEADD(HOUR, -1, SYSDATETIME()), DATEADD(HOUR, -1, SYSDATETIME()), 30.00, 'ENCERRADA', 'DEMO-QR-UTILIZADO-0001', 0, NULL),
  (1, 5, DATEADD(DAY, -2, SYSDATETIME()), DATEADD(HOUR, 2, DATEADD(DAY, -2, SYSDATETIME())), DATEADD(DAY, -2, SYSDATETIME()), 50.00, 'ENCERRADA', 'DEMO-SESSAO-HIST-0001', 0, 'TUV1W23'),
  (2, 6, DATEADD(DAY, -3, SYSDATETIME()), DATEADD(HOUR, 3, DATEADD(DAY, -3, SYSDATETIME())), DATEADD(DAY, -3, SYSDATETIME()), 60.00, 'ENCERRADA', 'DEMO-SESSAO-HIST-0002', 0, 'XYZ4A56'),
  (3, 4, DATEADD(DAY, -4, SYSDATETIME()), DATEADD(HOUR, 1, DATEADD(DAY, -4, SYSDATETIME())), DATEADD(DAY, -4, SYSDATETIME()), 18.00, 'ENCERRADA', 'DEMO-SESSAO-HIST-0003', 0, 'GHI7J89'),
  (4, 8, DATEADD(DAY, -5, SYSDATETIME()), DATEADD(HOUR, 4, DATEADD(DAY, -5, SYSDATETIME())), DATEADD(DAY, -5, SYSDATETIME()), 32.00, 'ENCERRADA', 'DEMO-SESSAO-HIST-0004', 0, 'JKL2M34');
  GO
